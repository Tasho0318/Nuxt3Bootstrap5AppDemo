...
6歳年下の実弟ラルフ・シューマッハはウィリアムズなどで6勝を挙げた元F1ドライバー。息子のミック・シューマッハもF1ドライバーであったが、2023年はシートを失いミハエルが最後に過ごしたメルセデスのリザーブドライバーになった。
            ...
            <p>
                ...
                Williamsのマシーンはハイテクデバイスが積まれていましたが、FIAのレギュレーションによりハイテクデバイスが制限されました。
                そのためセナが操るFW16はとても運転が難しいものでした。
            </p>
            ...
            <p>
                ...
                事故の原因としては様々ありますが、最も有力な説だとステアリングをセナが好む大径のものに変えるためにステアリングシャフトを切断して再溶接したが強度不足だった、コクピットが狭く膝が当たるためステアリングシャフトの膝の部分を若干削った、などが原因でステアリングシャフトが折れてハンドルが全く効かなくなったという説です。
